        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg mb-6">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">إضافة فصل جديد</h1>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">إنشاء فصل دراسي جديد في المنصة</p>
                    </div>
