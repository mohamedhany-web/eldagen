    ...
    <form action="{{ route('admin.exams.update', $exam) }}" method="POST">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="xl:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">إعدادات الامتحان</h3>
                    </div>
                    <div class="p-6 space-y-6">
                        <!-- الصف الأول -->
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="attempts_allowed" id="attempts_allowed" 
                                       ...
                                       class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                                       placeholder="1">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">0 = محاولات غير محدودة</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- درجة النجاح -->
                            <div>
                                <label for="passing_marks" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            ...
                            <div>
                                ...
                                <input type="number" name="total_marks" id="total_marks" 
                                       ...
                                       class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                                       placeholder="100">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">سيتم حسابها تلقائياً من الأسئلة إذا تركت فارغة</p>
                                @error('total_marks')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">توقيتات الامتحان</h3>
                    </div>
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- وقت البداية -->
                            <div>
                                ...
                                <input type="datetime-local" name="start_time" id="start_time" 
                                       ...
                                       class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">اتركه فارغاً للإتاحة الفورية</p>
                                @error('start_time')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_time" id="end_time" 
                                       ...
                                       class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">اتركه فارغاً للإتاحة المستمرة</p>
                                @error('end_time')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">إعدادات العرض والمراجعة</h3>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="randomize_questions" class="mr-2 text-sm text-gray-900 dark:text-white">
                                        خلط ترتيب الأسئلة
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="randomize_options" id="randomize_options" value="1"
                                           ...
                                           class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                    <label for="randomize_options" class="mr-2 text-sm text-gray-900 dark:text-white">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="show_results_immediately" id="show_results_immediately" value="1"
                                           ...
                                           class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                    <label for="show_results_immediately" class="mr-2 text-sm text-gray-900 dark:text-white">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="allow_review" id="allow_review" value="1"
                                           ...
                                           class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                    <label for="allow_review" class="mr-2 text-sm text-gray-900 dark:text-white">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="show_correct_answers" id="show_correct_answers" value="1"
                                           ...
                                           class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                    <label for="show_correct_answers" class="mr-2 text-sm text-gray-900 dark:text-white">
                                        عرض الإجابات الصحيحة
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="show_explanations" id="show_explanations" value="1"
                                           ...
                                           class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                    <label for="show_explanations" class="mr-2 text-sm text-gray-900 dark:text-white">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="prevent_tab_switch" id="prevent_tab_switch" value="1"
                                           ...
                                           class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                    <label for="prevent_tab_switch" class="mr-2 text-sm text-gray-900 dark:text-white">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="auto_submit" id="auto_submit" value="1"
                                           ...
                                           class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                    <label for="auto_submit" class="mr-2 text-sm text-gray-900 dark:text-white">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="require_camera" id="require_camera" value="1"
                                           ...
                                           class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                    <label for="require_camera" class="mr-2 text-sm text-gray-900 dark:text-white">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="require_microphone" id="require_microphone" value="1"
                                           ...
                                           class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                                    <label for="require_microphone" class="mr-2 text-sm text-gray-900 dark:text-white">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">حالة الامتحان</h3>
                    </div>
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" value="1" 
                                   ...
                                   class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                            <label for="is_active" class="mr-2 text-sm font-medium text-gray-900 dark:text-white">
                                امتحان نشط
                            </label>
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400">الامتحانات غير النشطة لن تظهر للطلاب</p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="p-6 space-y-4 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="text-gray-900 dark:text-white">{{ $exam->created_at->format('d/m/Y H:i') }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-400">آخر تحديث:</span>
                            <span class="text-gray-900 dark:text-white">{{ $exam->updated_at->format('d/m/Y H:i') }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-400">عدد الأسئلة:</span>
                            <span class="text-gray-900 dark:text-white">{{ $exam->examQuestions->count() }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-400">المحاولات:</span>
                            <span class="text-gray-900 dark:text-white">{{ $exam->attempts->count() }}</span>
                        </div>
                    </div>
                </div>
