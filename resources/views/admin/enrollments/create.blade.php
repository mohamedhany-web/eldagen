    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">تسجيل طالب في كورس</h3>
        ...
        <form method="POST" action="{{ route('admin.enrollments.store') }}" class="p-6">
            ...
            <div id="studentInfo" class="mt-6 hidden">
                <div class="bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                    <h4 class="font-medium text-blue-900 dark:text-blue-100 mb-2">معلومات الطالب المختار:</h4>
                    <div id="studentDetails" class="text-sm text-blue-800 dark:text-blue-200">
            ...
            <div class="mt-6 bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <h4 class="font-medium text-gray-900 dark:text-white mb-3">البحث السريع بالهاتف</h4>
                ...
                resultDiv.innerHTML = `
                    <div class="bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded p-3">
                        <div class="flex items-center">
                            ...
                            <span class="text-green-800 dark:text-green-200">تم العثور على الطالب واختياره تلقائياً</span>
                        </div>
                    </div>
                `;
                ...
                resultDiv.innerHTML = `
                    <div class="bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded p-3">
                        <div class="flex items-center">
                            ...
                            <span class="text-red-800 dark:text-red-200">${data.error}</span>
                        </div>
                    </div>
                `;
            }
            ...
            resultDiv.innerHTML = `
                <div class="bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded p-3">
                    <div class="flex items-center">
                        ...
                        <span class="text-red-800 dark:text-red-200">حدث خطأ في البحث</span>
                    </div>
                </div>
            `;
        });
