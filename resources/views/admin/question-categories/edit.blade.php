        ...
        <div class="xl:col-span-2">
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">تعديل بيانات التصنيف</h3>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">اختر تصنيف أب لجعله تصنيف فرعي</p>
                                @error('parent_id')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="order" id="order" min="0" 
                                       ...
                                       class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white">
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">ترتيب ظهور التصنيف في القائمة</p>
                                @error('order')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            <label class="flex items-center">
                                ...
                                <span class="mr-2 text-sm font-medium text-gray-700 dark:text-gray-300">تصنيف نشط</span>
                            </label>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">التصنيفات غير النشطة لن تظهر عند إنشاء الأسئلة</p>
                        </div>

                        <!-- أزرار الحفظ -->
                        <div class="flex items-center justify-end space-x-4 space-x-reverse pt-6 border-t border-gray-200 dark:border-gray-700">
                            <a href="{{ route('admin.question-categories.show', $questionCategory) }}" 
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6 space-y-3">
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">إجمالي الأسئلة</span>
                        <span class="text-sm font-bold text-gray-900 dark:text-white">{{ $questionCategory->total_questions_count }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">أسئلة مباشرة</span>
                        <span class="text-sm font-bold text-gray-900 dark:text-white">{{ $questionCategory->questions->count() }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">تصنيفات فرعية</span>
                        <span class="text-sm font-bold text-gray-900 dark:text-white">{{ $questionCategory->children->count() }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">تاريخ الإنشاء</span>
                        <span class="text-sm text-gray-900 dark:text-white">{{ $questionCategory->created_at->format('Y-m-d') }}</span>
                    </div>
                </div>
            </div>
            ...
            @if($questionCategory->questions->count() > 0 || $questionCategory->children->count() > 0)
                <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="text-sm font-medium text-yellow-800 dark:text-yellow-200">تنبيه</span>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">إجراءات سريعة</h3>
                </div>
                <div class="p-6 space-y-3">
