...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.advanced-courses.index') }}" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">إدارة الكورسات</a>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.users') }}" class="text-sm text-green-600 dark:text-green-400 hover:underline">المستخدمون</a>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300">
            ...
            <div class="mt-4">
                <a href="{{ route('dashboard') }}" class="text-sm text-purple-600 dark:text-purple-400 hover:underline">لوحة التحكم</a>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.advanced-courses.index') }}" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">عرض الكل</a>
                </div>
            </div>
            <div class="p-6">
                <div class="space-y-4">
            ...
            <div class="p-6">
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200">
                        <div class="w-12 h-12 bg-gradient-to-br from-green-400 to-blue-600 rounded-lg flex items-center justify-center flex-shrink-0">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{{ route('admin.advanced-courses.create') }}" class="flex flex-col items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors duration-200">
            ...
            <a href="{{ route('admin.advanced-courses.index') }}" class="flex flex-col items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors duration-200">
                <i class="fas fa-tasks text-green-600 dark:text-green-400 text-2xl mb-2"></i>
                <span class="text-sm font-medium text-green-700 dark:text-green-300">إدارة الكورسات</span>
            </a>
            
            <a href="{{ route('admin.exams.index') }}" class="flex flex-col items-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors duration-200">
                <i class="fas fa-clipboard-check text-purple-600 dark:text-purple-400 text-2xl mb-2"></i>
                <span class="text-sm font-medium text-purple-700 dark:text-purple-300">الاختبارات</span>
            </a>
            
            <a href="{{ route('admin.statistics') }}" class="flex flex-col items-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors duration-200">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">نظرة عامة</h3>
        </div>
        <div class="p-6">
            <div class="text-center py-6 text-gray-500 dark:text-gray-400">
                <i class="fas fa-calendar-day text-3xl mb-2"></i>
                <p class="text-sm">لا توجد مهام معروضة لهذا اليوم</p>
                <a href="{{ route('admin.exams.index') }}" class="inline-flex items-center mt-3 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors duration-200">
