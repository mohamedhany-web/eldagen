...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8"
    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">سجل دخولك للوصول إلى منصة التعلم</p>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="tel" 
                           ...
                           value="{{ old('phone') }}"
                           required 
                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-colors duration-200 @error('phone') border-red-500 @enderror" 
