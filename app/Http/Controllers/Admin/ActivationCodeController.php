...
{
    /**
     * عرض قائمة الأكواد + نموذج توليد أكواد جديدة
     */
    public function index(Request $request)
    {
        ...
        return view('admin.activation-codes.index', compact('codes', 'courses', 'stats'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.activation-codes.index')->with('success', $message);
    }
